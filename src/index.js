...
(function() {
  var SPEC, app, create_html, express, file_or_url_to_absolute, fs, launch_webapp, launch_webapp_once, path, pkg, program, raml_parser, request, spawn, starts_with, test, webapp_is_listening;
  ...
  test = function(ramlObj) {
    var expanded, ramljsonexpander, yaml, yml;
